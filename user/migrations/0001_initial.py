    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(blank=True, choices=[('m', '男'), ('f', '女')], max_length=2, null=True, verbose_name='性别')),
                ('date_of_birth', models.DateField(blank=True, null=True, verbose_name='出生日期')),
                ('avatar', models.ImageField(blank=True, upload_to='users/avatar/%Y/%m/%d', verbose_name='头像')),
