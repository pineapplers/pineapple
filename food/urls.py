...
from .views import food_latest, food_detail, food_rate, food_category, food_tag, explore, hot, food_wta, food_ate, food_create

urlpatterns = [
    url(r'^$', food_latest, name='list'),
    url(r'^create/$', food_create, name='create'),
